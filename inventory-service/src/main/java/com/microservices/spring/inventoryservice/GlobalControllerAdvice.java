...
import com.microservices.spring.inventoryservice.exceptions.InternalServerErrorException;
...
public class GlobalControllerAdvice {
  ...
  private ResponseEntity<ExceptionResponse> handlePostgresDuplicateKeyException(
      DataIntegrityViolationException baseException) {
    String errorMessage = baseException.getMostSpecificCause().getMessage();
